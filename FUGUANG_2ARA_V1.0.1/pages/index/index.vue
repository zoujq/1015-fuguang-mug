	...
	<view class="content">
		<view class="popup-lalay" :class="[pop_show]">
			<view class="dialog-connect-fail"  >
				...
				<view class="d-footer-container">
					<view class="chongshi" @click="shao_hou_retry">稍后再试</view>
					<view class="like" @click="like_chong_lian">立即重连</view>
				</view>
			</view>
		</view>
		<view class="error-notice">
			<image src="../../static/error_notice.png"></image>
			<view class="notic-text">接触不良，请检查排线是否接触好！</view>
		</view>
		<image @click="click_s" class="idimg" src="../../static/xxhdpi/idimg.png">
			
		</image>
		<image class="logo" src="../../static/xxhdpi/logo.png" @click="testx"></image>
		...
		<view class="cup-state">
			...
			<view class="temp-state">
				<view class="temp-num">
					<view class="temp-num-v">44</view>
					<view class="temp-num-c">℃</view>
				</view>
				<view class="temp-shuiwen">水温</view>
			...
			<view class="state-con">
				...
				<view class="battery-state">
					...
					<image class="charging" src="../../static/charging.png"></image>
		...
		<view class="cup-set">
			<view class="cup-set-title">温度设置</view>
			<view class="cup-set-container">
				<view class="cup-set-item">
					<view class="set-icon">
						<image src="../../static/xxhdpi/ic_water.png"></image>
					</view>
					<view class="item-name">水45℃</view>
				</view>
				<view class="cup-set-item">
					<view class="set-icon">
						<image src="../../static/xxhdpi/ic_milk.png"></image>
					</view>
					<view class="item-name">牛奶50℃</view>
				</view>
				<view class="cup-set-item">
					<view class="set-icon">
						<image src="../../static/xxhdpi/ic_blacktea.png"></image>
					</view>
					<view class="item-name">红茶55℃</view>
				</view>
				<view class="cup-set-item">
					<view class="set-icon">
						<image src="../../static/xxhdpi/ic_greentea.png"></image>
					</view>
					<view class="item-name">绿茶60℃</view>
				</view>
				<view class="cup-set-item">
					<view class="set-icon">
						<image src="../../static/xxhdpi/ic_coffee.png"></image>
					</view>
					<view class="item-name">咖啡65℃</view>
				</view>
			</view>
		</view>
	</view>
